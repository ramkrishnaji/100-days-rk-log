...
## Log of Round 1 of #100DaysOfCode - done in 2023

### Day 1: March 1 Wednesday

**Today's Progress**: Spent time learning about my 100 days goals.Solved basic print statement.

**Thoughts:** feeling excited on the first day.
...
**Today's Progress**: starting with a c++ problem statement which identifies whether an input is vowel or consonant.
...
**Today's Progress**: worked on C++ program to check whether alphabet or not.

**Thoughts:** felt a little overwhelming but managed to do it.
